...
wpi::math::MecanumDriveWheelPositions StructType::Unpack(
  ...
  return wpi::math::MecanumDriveWheelPositions{
      wpi::units::meters<>{wpi::util::UnpackStruct<double, kFrontLeftOff>(data)},
      wpi::units::meters<>{
          wpi::util::UnpackStruct<double, kFrontRightOff>(data)},
      wpi::units::meters<>{wpi::util::UnpackStruct<double, kRearLeftOff>(data)},
      wpi::units::meters<>{wpi::util::UnpackStruct<double, kRearRightOff>(data)},
  };
}

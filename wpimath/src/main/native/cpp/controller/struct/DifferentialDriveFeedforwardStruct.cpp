...
wpi::util::Struct<wpi::math::DifferentialDriveFeedforward>::Unpack(
  ...
  return {decltype(1_V /
          ...
          decltype(1_V /
                   1_mps){wpi::util::UnpackStruct<double, KV_ANGULAR_OFF>(data)},
          decltype(1_V / 1_mps_sq){
...
void wpi::util::Struct<wpi::math::DifferentialDriveFeedforward>::Pack(
  ...
  wpi::util::PackStruct<KV_LINEAR_OFF>(data, value.m_kVLinear.value());
  wpi::util::PackStruct<KA_LINEAR_OFF>(data, value.m_kALinear.value());
  wpi::util::PackStruct<KV_ANGULAR_OFF>(data, value.m_kVAngular.value());
  wpi::util::PackStruct<KA_ANGULAR_OFF>(data, value.m_kAAngular.value());
}

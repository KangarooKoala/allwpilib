...
frc::DCMotor StructType::Unpack(std::span<const uint8_t> data) {
  return frc::DCMotor{
      wpi::UnpackStruct<double, kNominalVoltageOff>(data) * units::volt,
      wpi::UnpackStruct<double, kStallTorqueOff>(data) * units::newton_meter,
      wpi::UnpackStruct<double, kStallCurrentOff>(data) * units::ampere,
      wpi::UnpackStruct<double, kFreeCurrentOff>(data) * units::ampere,
          wpi::UnpackStruct<double, kFreeSpeedOff>(data) * units::radians_per_second,
  };
}

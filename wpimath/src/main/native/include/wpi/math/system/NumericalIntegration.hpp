...
T RK4(F&& f, T x, wpi::units::seconds<> dt) {
...
T RK4(F&& f, T x, U u, wpi::units::seconds<> dt) {
  const auto h = dt.value();
 ...
 */
template <typename F, typename T>
T RK4(F&& f, wpi::units::seconds<> t, T y, wpi::units::seconds<> dt) {
  const auto h = dt.value();
 ...
 */
template <typename F, typename T, typename U>
T RKDP(F&& f, T x, U u, wpi::units::seconds<> dt, double maxError = 1e-6) {
 ...
 */
template <typename F, typename T>
T RKDP(F&& f, wpi::units::seconds<> t, T y, wpi::units::seconds<> dt,
  ...
  while (dtElapsed < dt.value()) {
    do {
      ...
      // clang-format off
      T k1 = f(t, y);
      T k2 = f(t + wpi::units::seconds<>{h} * c[0], y + h * (A[0][0] * k1));
      T k3 = f(t + wpi::units::seconds<>{h} * c[1], y + h * (A[1][0] * k1 + A[1][1] * k2));
      T k4 = f(t + wpi::units::seconds<>{h} * c[2], y + h * (A[2][0] * k1 + A[2][1] * k2 + A[2][2] * k3));
      T k5 = f(t + wpi::units::seconds<>{h} * c[3], y + h * (A[3][0] * k1 + A[3][1] * k2 + A[3][2] * k3 + A[3][3] * k4));
      T k6 = f(t + wpi::units::seconds<>{h} * c[4], y + h * (A[4][0] * k1 + A[4][1] * k2 + A[4][2] * k3 + A[4][3] * k4 + A[4][4] * k5));
      // clang-format on
      ...
      newY = y + h * (A[5][0] * k1 + A[5][1] * k2 + A[5][2] * k3 +
                      A[5][3] * k4 + A[5][4] * k5 + A[5][5] * k6);
      T k7 = f(t + wpi::units::seconds<>{h} * c[5], newY);

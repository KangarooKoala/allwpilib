...
class WPILIB_DLLEXPORT TrajectoryConfig {
 public:
   ...
   */
  TrajectoryConfig(wpi::units::meters_per_second<> maxVelocity,
   ...
   */
  void SetStartVelocity(wpi::units::meters_per_second<> startVelocity) {
   ...
   */
  void SetEndVelocity(wpi::units::meters_per_second<> endVelocity) {
   ...
   */
  wpi::units::meters_per_second<> StartVelocity() const {
   ...
   */
  wpi::units::meters_per_second<> EndVelocity() const { return m_endVelocity; }

  /**
   * Returns the maximum velocity of the trajectory.
   * @return The maximum velocity of the trajectory.
   */
  wpi::units::meters_per_second<> MaxVelocity() const { return m_maxVelocity; }

  /**
   * Returns the maximum acceleration of the trajectory.
   * @return The maximum acceleration of the trajectory.
   */
  wpi::units::meters_per_second_squared<> MaxAcceleration() const {
 ...
 private:
  wpi::units::meters_per_second<> m_startVelocity = 0_mps;
  wpi::units::meters_per_second<> m_endVelocity = 0_mps;
  wpi::units::meters_per_second<> m_maxVelocity;
  wpi::units::meters_per_second_squared<> m_maxAcceleration;

...
TEST(SwerveDrivePoseEstimator3dTest, SimultaneousVisionMeasurements) {
  ...
  estimator.UpdateWithTime(0.0 * mp::s, frc::Rotation3d{}, {fl, fr, bl, br});
...
TEST(SwerveDrivePoseEstimator3dTest, TestSampleAt) {
  ...
  for (double time = 1; time <= 2 + 1e-9; time += 0.02) {
    wpi::array<frc::SwerveModulePosition, 4> wheelPositions{
        {frc::SwerveModulePosition{time * mp::m, frc::Rotation2d{}},
         frc::SwerveModulePosition{time * mp::m, frc::Rotation2d{}},
         frc::SwerveModulePosition{time * mp::m, frc::Rotation2d{}},
         frc::SwerveModulePosition{time * mp::m, frc::Rotation2d{}}}};
    estimator.UpdateWithTime(time * mp::s, frc::Rotation3d{}, wheelPositions);
  }
...
TEST(SwerveDrivePoseEstimator3dTest, TestReset) {
  ...
  // Test reset position
  {
    frc::SwerveModulePosition modulePosition{1.0 * mp::m, frc::Rotation2d{}};
  ...
  {
    frc::SwerveModulePosition modulePosition{2.0 * mp::m, frc::Rotation2d{}};
  ...
  // Test orientation
  {
    frc::SwerveModulePosition modulePosition{3.0 * mp::m, frc::Rotation2d{}};
    estimator.Update(frc::Rotation3d{}, {modulePosition, modulePosition,
                                         modulePosition, modulePosition});
  }

...
TEST(ChassisAccelerationsTest, DefaultConstructor) {
  ...
  EXPECT_NEAR(accelerations.ax.value(), 0.0, EPSILON);
  EXPECT_NEAR(accelerations.ay.value(), 0.0, EPSILON);
  EXPECT_NEAR(accelerations.alpha.value(), 0.0, EPSILON);
}
...
TEST(ChassisAccelerationsTest, ParameterizedConstructor) {
  ...
  EXPECT_NEAR(accelerations.ax.value(), 1.0, EPSILON);
  EXPECT_NEAR(accelerations.ay.value(), 2.0, EPSILON);
  EXPECT_NEAR(accelerations.alpha.value(), 3.0, EPSILON);
}
...
TEST(ChassisAccelerationsTest, ToRobotRelative) {
  ...
  EXPECT_NEAR(chassisAccelerations.ax.value(), 0.0, EPSILON);
  EXPECT_NEAR(chassisAccelerations.ay.value(), 1.0, EPSILON);
  EXPECT_NEAR(chassisAccelerations.alpha.value(), 0.5, EPSILON);
}
...
TEST(ChassisAccelerationsTest, ToFieldRelative) {
  ...
  EXPECT_NEAR(chassisAccelerations.ax.value(), 1.0 / std::sqrt(2.0), EPSILON);
  EXPECT_NEAR(chassisAccelerations.ay.value(), 1.0 / std::sqrt(2.0), EPSILON);
  EXPECT_NEAR(chassisAccelerations.alpha.value(), 0.5, EPSILON);
}
...
TEST(ChassisAccelerationsTest, Plus) {
  ...
  EXPECT_NEAR(chassisAccelerations.ax.value(), 3.0, EPSILON);
  EXPECT_NEAR(chassisAccelerations.ay.value(), 2.0, EPSILON);
  EXPECT_NEAR(chassisAccelerations.alpha.value(), 1.0, EPSILON);
}
...
TEST(ChassisAccelerationsTest, Minus) {
  ...
  EXPECT_NEAR(chassisAccelerations.ax.value(), -1.0, EPSILON);
  EXPECT_NEAR(chassisAccelerations.ay.value(), 0.0, EPSILON);
  EXPECT_NEAR(chassisAccelerations.alpha.value(), 0.5, EPSILON);
}
...
TEST(ChassisAccelerationsTest, UnaryMinus) {
  ...
  EXPECT_NEAR(chassisAccelerations.ax.value(), -1.0, EPSILON);
  EXPECT_NEAR(chassisAccelerations.ay.value(), -0.5, EPSILON);
  EXPECT_NEAR(chassisAccelerations.alpha.value(), -0.75, EPSILON);
}
...
TEST(ChassisAccelerationsTest, Multiplication) {
  ...
  EXPECT_NEAR(chassisAccelerations.ax.value(), 2.0, EPSILON);
  EXPECT_NEAR(chassisAccelerations.ay.value(), 1.0, EPSILON);
  EXPECT_NEAR(chassisAccelerations.alpha.value(), 1.5, EPSILON);
}

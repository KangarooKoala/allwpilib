...
TEST(Translation3dTest, Nearest) {
  const Translation3d origin{0 * mp::m, 0 * mp::m, 0 * mp::m};

  // Distance sort
  // translations are in order of closest to farthest away from the origin at
  // various positions in 3D space.
  const Translation3d translation1{1 * mp::m, 0 * mp::m, 0 * mp::m};
  const Translation3d translation2{0 * mp::m, 2 * mp::m, 0 * mp::m};
  const Translation3d translation3{0 * mp::m, 0 * mp::m, 3 * mp::m};
  const Translation3d translation4{2 * mp::m, 2 * mp::m, 2 * mp::m};
  const Translation3d translation5{3 * mp::m, 3 * mp::m, 3 * mp::m};

...
TEST(Twist3dTest, StraightX) {
  ...
  Transform3d expected{5.0 * mp::m, 0.0 * mp::m, 0.0 * mp::m, Rotation3d{}};
...
TEST(Twist3dTest, StraightY) {
  ...
  Transform3d expected{0.0 * mp::m, 5.0 * mp::m, 0.0 * mp::m, Rotation3d{}};
  EXPECT_EQ(expected, straightPose);
}
...
TEST(Twist3dTest, StraightZ) {
  ...
  Transform3d expected{0.0 * mp::m, 0.0 * mp::m, 5.0 * mp::m, Rotation3d{}};
  EXPECT_EQ(expected, straightPose);
}
...
TEST(Twist3dTest, QuarterCircle) {
  ...
  Transform3d expected{5.0 * mp::m, 5.0 * mp::m, 0.0 * mp::m,
...
TEST(Twist3dTest, DiagonalNoDtheta) {
  ...
  Transform3d expected{2.0 * mp::m, 2.0 * mp::m, 0.0 * mp::m, Rotation3d{}};

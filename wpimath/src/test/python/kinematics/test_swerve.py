...
def test_swerve4_normalize():
    ...
    assert states[0].speed == pytest.approx(5.0 * FACTOR)
    assert states[1].speed == pytest.approx(6.0 * FACTOR)
    assert states[2].speed == pytest.approx(4.0 * FACTOR)
    assert states[3].speed == pytest.approx(7.0 * FACTOR)

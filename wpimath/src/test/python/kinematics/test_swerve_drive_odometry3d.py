...
def test_initialize(odometry3d_test):
    ...
    assert pose.rotation().toRotation2d().degrees() == pytest.approx(45, abs=EPSILON)
...
def test_two_iterations(odometry3d_test):
    ...
    assert pose.rotation().toRotation2d().degrees() == pytest.approx(0.0, abs=EPSILON)
...
def test_90_degree_turn(odometry3d_test):
    ...
    assert pose.z == pytest.approx(0.0, abs=EPSILON)
    assert pose.rotation().toRotation2d().degrees() == pytest.approx(90.0, abs=EPSILON)

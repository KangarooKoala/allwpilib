...
class SwerveModuleStateTest {
  ...
  void testInterpolate() {
    ...
    assertAll(
        () -> assertEquals(1.0, atStart.speed, EPSILON),
    ...
    assertAll(
        () -> assertEquals(5.0, atEnd.speed, EPSILON),
    ...
    assertAll(
        () -> assertEquals(3.0, atMidpoint.speed, EPSILON),
    ...
    assertAll(
        () -> assertEquals(2.0, atQuarter.speed, EPSILON),
    ...
    assertAll(
        () -> assertEquals(1.0, belowRange.speed, EPSILON),
    ...
    assertAll(
        () -> assertEquals(5.0, aboveRange.speed, EPSILON),
    ...
    assertAll(
        () -> assertEquals(3.0, midpointWrap.speed, EPSILON),

...
class Pose2dTest {
  ...
  void testRotateAround() {
    var initial = new Pose2d(5, 0, Rotation2d.ZERO);
    var point = Translation2d.ZERO;

    var rotated = initial.rotateAround(point, Rotation2d.PI);
  ...
  @Test
  void testNearest() {
    var origin = Pose2d.ZERO;

    // Distance sort
    // each poseX is X units away from the origin at a random angle.
    final var pose1 =
        new Pose2d(new Translation2d(1, Rotation2d.fromDegrees(45)), Rotation2d.ZERO);
    final var pose2 = new Pose2d(new Translation2d(2, Rotation2d.CCW_PI_2), Rotation2d.ZERO);
    final var pose3 =
        new Pose2d(new Translation2d(3, Rotation2d.fromDegrees(135)), Rotation2d.ZERO);
    final var pose4 = new Pose2d(new Translation2d(4, Rotation2d.PI), Rotation2d.ZERO);
    final var pose5 = new Pose2d(new Translation2d(5, Rotation2d.CW_PI_2), Rotation2d.ZERO);
    ...
    // rounding error.
    final var translation = new Translation2d(1, Rotation2d.ZERO);

    final var poseA = new Pose2d(translation, Rotation2d.ZERO);
    ...
    final var poseD = new Pose2d(translation, Rotation2d.CCW_PI_2);

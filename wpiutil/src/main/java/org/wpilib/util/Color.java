...
public class Color {
  ...
  public static final Color CHOCOLATE =
      new Color(0.8235294f, 0.4117647f, 0.11764706f, "CHOCOLATE");
  ...
  public static final Color GAINSBORO =
      new Color(0.8627451f, 0.8627451f, 0.8627451f, "GAINSBORO");
  ...
  public static final Color TURQUOISE =
      new Color(0.2509804f, 0.8784314f, 0.8156863f, "TURQUOISE");

...
template <typename MB>
constexpr auto MAP_MODE = MappedFileRegion::READ_ONLY;
template <>
constexpr auto MAP_MODE<MemoryBuffer> = MappedFileRegion::READ_ONLY;
template <>
constexpr auto MAP_MODE<WritableMemoryBuffer> = MappedFileRegion::PRIV;
template <>
